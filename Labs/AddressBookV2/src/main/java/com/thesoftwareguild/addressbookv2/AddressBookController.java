...
public class AddressBookController {
    ...
    private AddressBookDao book = new AddressBookImpl();
...
//        Integer addressId = con.readInt("Please enter the ID of the address that you would like to view");
//        Address currentAddress = book.getAddress(addressId);
//        if (currentAddress != null) {
//            con.print(String.valueOf(currentAddress.getAddressId()));
//
//            con.print(currentAddress.getFirstName() + " " + currentAddress.getLastName());
...
//        Integer addressId = con.readInt("Please enter the ID of the Address you would like to be removed");
