...
public class StaticPage {
    ...
    public int hashCode() {
        ...
        hash = 73 * hash + Arrays.hashCode(this.userIds);
        hash = 73 * hash + Objects.hashCode(this.postBody);
        hash = 73 * hash + Objects.hashCode(this.postDate);
        hash = 73 * hash + Objects.hashCode(this.postExcerpt);
        hash = 73 * hash + Objects.hashCode(this.lastEditDate);
        hash = 73 * hash + (this.isPrivate ? 1 : 0);
        return hash;
    }
