 ...
 */
package com.thesoftwareguild._madlibrandom;
...
public class MadLibRandom {
    ...
    public static void main(String[] args) {
        String[] males = {"Rob", "Darius", "Cliff", "Monty", "Reggie", "Gus",
            "Vernon", "Maynard", "Gavin", "Ward", "Stefan", "Winfred"};

        String[] females = {"Lauren", "Kelly", "Anne", "Jamie", "Kristin", "Caitlin",
            "Vernon", "Maynard", "Gavin", "Ward", "Stefan", "Winfred"};
        ...
        int mi = 0 + (int) (Math.random() * males.length);
        int fi = 0 + (int) (Math.random() * females.length);
        int ai1 = 0 + (int) (Math.random() * adjectives.length);
        int ai2 = 0 + (int) (Math.random() * adjectives.length);
        int vi1 = 0 + (int) (Math.random() * verbs_pt.length);
        int ni1 = 0 + (int) (Math.random() * nouns.length);
        int numi = 0 + (int) (Math.random() * numbers.length);
        int ci = 0 + (int) (Math.random() * colors.length);
        int ni2 = 0 + (int) (Math.random() * nouns.length);
        int bi = 0 + (int) (Math.random() * bodyparts_pl.length);
        int vi2 = 0 + (int) (Math.random() * verbs_pt.length);
